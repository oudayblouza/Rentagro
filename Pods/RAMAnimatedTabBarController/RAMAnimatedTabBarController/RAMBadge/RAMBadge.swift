...
open class RAMBadge: UILabel {
    ...
    @objc internal var topConstraint: NSLayoutConstraint?
    @objc internal var centerXConstraint: NSLayoutConstraint?

    @objc open class func badge() -> RAMBadge {
    ...
    @objc internal func createSizeConstraints(_ size: CGSize) {
    ...
    @objc open func addBadgeOnView(_ onView:UIView) {
