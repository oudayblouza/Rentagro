...
internal class CDAlertHeaderView: UIView {
    ...
    @objc internal var circleFillColor: UIColor? {
        didSet {
    ...
    @objc internal var isIconFilled: Bool = false
    @objc internal var alertBackgroundColor: UIColor = UIColor.white.withAlphaComponent(0.9)
    @objc internal var hasShadow: Bool = true
