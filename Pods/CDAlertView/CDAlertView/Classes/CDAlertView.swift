...
open class CDAlertView: UIView {
    ...
    @objc public var actionSeparatorColor: UIColor = UIColor(red: 50 / 255,
                                                       green: 51 / 255,
                                                       blue: 53 / 255,
                                                       alpha: 0.12)
    @objc public var titleTextColor: UIColor = UIColor(red: 50 / 255,
                                                 green: 51 / 255,
                                                 blue: 53 / 255,
                                                 alpha: 1)

    @objc public var messageTextColor: UIColor = UIColor(red: 50 / 255,
                                                   green: 51 / 255,
                                                   blue: 53 / 255,
                                                   alpha: 1)

    @objc public var textFieldTextColor: UIColor = UIColor(red: 50 / 255,
                                                     green: 51 / 255,
                                                     blue: 53 / 255,
                                                     alpha: 1)

    @objc public var titleFont: UIFont = UIFont.boldSystemFont(ofSize: 17) {
        didSet {
            titleLabel.font = titleFont
        }
    }

    @objc public var messageFont: UIFont = UIFont.systemFont(ofSize: 13) {
        didSet {
            messageLabel.font = messageFont
        }
    }

    @objc public var textFieldFont: UIFont = UIFont.systemFont(ofSize: 15) {
        didSet {
            textField.font = textFieldFont
        }
    }

    @objc public var textFieldReturnKeyType: UIReturnKeyType = .default {
        didSet {
            textField.returnKeyType = textFieldReturnKeyType
        }
    }

    @objc public var textFieldIsSecureTextEntry: Bool = false {
        didSet {
            textField.isSecureTextEntry = textFieldIsSecureTextEntry
        }
    }

    @objc public var textFieldTextAlignment: NSTextAlignment = .left {
        didSet {
            textField.textAlignment = textFieldTextAlignment
        }
    }

    @objc public var textFieldPlaceholderText: String? = nil {
        didSet {
            textField.placeholder = textFieldPlaceholderText
        }
    }

    @objc public var isTextFieldHidden: Bool = true {
        didSet {
    ...
    @objc public var textFieldAutocapitalizationType: UITextAutocapitalizationType = .none {
        didSet {
            textField.autocapitalizationType = textFieldAutocapitalizationType
        }
    }

    @objc public var textFieldBackgroundColor: UIColor = UIColor.white.withAlphaComponent(0.9) {
        didSet {
            textField.backgroundColor = textFieldBackgroundColor
        }
    }

    @objc public var textFieldTintColor: UIColor = UIColor.white.withAlphaComponent(0.9) {
        didSet {
            textField.tintColor = textFieldTintColor
        }
    }

    @objc public var textFieldText: String? {
        get {
    ...
    @objc public weak var textFieldDelegate: UITextFieldDelegate? {
        didSet {
    ...
    @objc public var hideAnimationDuration: TimeInterval = 0.5

    @objc public var textFieldHeight: CGFloat = 35.0

    @objc public var isActionButtonsVertical: Bool = false

    @objc public var hasShadow: Bool = true

    @objc public var isHeaderIconFilled: Bool = false

    @objc public var alertBackgroundColor: UIColor = UIColor.white.withAlphaComponent(0.9)

    @objc public var circleFillColor: UIColor? = nil

    @objc public var popupWidth: CGFloat = 255.0
    ...
    @objc public func show(_ completion: ((CDAlertView) -> Void)? = nil) {
    ...
    @objc public func hide(isPopupAnimated: Bool) {
    ...
    @objc public func add(action: CDAlertViewAction) {
        actions.append(action)
    }

    @objc public func textFieldBecomeFirstResponder() {
        if !isTextFieldHidden {
            textField.becomeFirstResponder()
        }
    }

    @objc public func textFieldResignFirstResponder() {
        if !isTextFieldHidden {
            textField.resignFirstResponder()
        }
    }
...
extension CDAlertView: CDAlertViewActionDelegate {
    @objc internal func didTap(action: CDAlertViewAction) {
        self.hide(animations: self.hideAnimations, isPopupAnimated: true)
    }
}
