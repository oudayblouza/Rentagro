...
open class FloatyManager: NSObject {
    ...
    @objc class func defaultInstance() -> FloatyManager {
        _ = FloatyManager.__once
        return StaticInstance.instance!
    }
    
    @objc var _floatyWindow: FloatyWindow? = nil
    @objc var floatyWindow: FloatyWindow {
        get {
    ...
    @objc var _floatyController: FloatyViewController? = nil
    @objc var floatyController: FloatyViewController {
        get {
    ...
    @objc open func show(_ animated: Bool = true) {
        if animated == true {
    ...
    @objc open func hide(_ animated: Bool = true) {
        if animated == true {
            UIView.animate(withDuration: 0.3, animations: { () -> Void in
    ...
    @objc open func toggle(_ animated: Bool = true) {
