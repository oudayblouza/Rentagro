...
open class FloatyItem: UIView {
    ...
    /**
     Reference to parent
     */
    @objc open weak var actionButton: Floaty?
    ...
    /**
     Item's title label.
     */
    @objc var _titleLabel: UILabel? = nil
     ...
     */
    @objc var _iconImageView: UIImageView? = nil
    ...
    */
    @objc public var itemBackgroundColor: UIColor? = nil {
