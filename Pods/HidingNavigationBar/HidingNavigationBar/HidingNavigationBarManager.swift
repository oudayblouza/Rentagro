...
open class HidingNavigationBarManager: NSObject, UIScrollViewDelegate, UIGestureRecognizerDelegate {
	...
	@objc unowned var viewController: UIViewController
	
	// The scrollView that will drive the contraction/expansion
	@objc unowned var scrollView: UIScrollView
	
	// The extension view to be shown beneath the navbar
	@objc weak var extensionView: UIView?
	
	// Control the resistance when scrolling up/down before the navbar expands/contracts again.
	@objc open var expansionResistance: CGFloat = 0
	@objc open var contractionResistance: CGFloat = 0
	...
	@objc open func manageBottomBar(_ view: UIView){
	...
	@objc open func addExtensionView(_ view: UIView) {
	...
	@objc open func shouldScrollToTop(){
    ...
    @objc var scrollViewContentInset: UIEdgeInsets {
