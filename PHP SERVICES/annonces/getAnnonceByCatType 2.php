...
$req = "select a.id id, a.nature nature, a.etat etat, a.titre titre, a.description description, a.prix prix, a.validite validite, a.dateDebut dateDebut, a.duree duree, a.numTel numTel, a.user_id user_id, a.type_id type_id, a.imagesdir imagesdir, a.nbrimages nbrimages, a.delegation_id delegation_id, t.id typeID, t.categorie_id cat FROM annonce a, type t WHERE a.type_id= t.id AND t.categorie_id='".$category."' AND a.nature='".$nature."'" ;
